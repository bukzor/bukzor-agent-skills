...
- [ ] Skill guidance still mandates per-repo re-declaration of a skill whose
      own `description:` already names the occasion — a pre-triggers leftover.
      llm-kb contradicts itself: SKILL.md says a root CLAUDE.md "needs no
...
- [ ] The homedir JSON-Schema survey is skill-scoped work now. Its six
      ...
      the six `todo.md` roll-ups reporting `No schema found` are that
      effort's lane -003
