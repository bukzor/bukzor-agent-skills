...
An unattributed judgment is a hidden oracle, and hidden oracles are
the failure this notation exists to prevent.

The judge's name carries its version wherever the verdict could turn on
