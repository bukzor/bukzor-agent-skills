...
# Helper command family: `bin/llm-claim-ledger-*`
...
commands are `bin/llm-claim-ledger-*`. Not `llm.ledger-*`, not any
other abbreviation.
...
`design.ledger.kb/good-smells.kb/enforceable-invariants-win.md`, an
...
- `design.ledger.kb/good-smells.kb/enforceable-invariants-win.md`,
