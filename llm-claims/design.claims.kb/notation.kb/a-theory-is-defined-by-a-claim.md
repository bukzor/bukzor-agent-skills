...
standing: agent
why:
    - claims-are-the-only-node-type.md
---
...
The alternative was header machinery: a second kind of object with
its own lifecycle, ungoverned by the ledger it structures. A second
instance of the system needed to demote a whole stratum and could,
because the stratum was a claim (prototype.llm-stet, 2026-08-08).
