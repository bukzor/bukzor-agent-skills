...
Bounded by v1's counter-lesson: self-application must not recurse
into skill-about-skill indirection towers. The system applies its
*data* patterns to itself; it does not need meta-machinery to do so.
