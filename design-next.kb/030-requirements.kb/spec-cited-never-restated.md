...
Checkable: grep for any definitional sentence from the spec; it
appears once. V1 fails this today (the frontmatter-directive
definition appears verbatim in three files).
