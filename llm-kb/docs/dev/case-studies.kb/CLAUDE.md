...
- One file per instructive incident.
- Filename: `$DATE-NNN-$SLUG.md` (`NNN` zero-padded ordinal within date).
- Raw-but-coherent narrative plus verbatim user corrective signals.

## What does NOT belong here

- Distilled failure modes → `../failure-modes.kb/`
- Distilled procedures → `../procedures.kb/`
- Distilled principles → `../principles.kb/`
