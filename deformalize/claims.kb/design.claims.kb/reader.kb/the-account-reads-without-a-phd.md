...
# The Account Reads Without a PhD
...
rules out the vocabulary in which the good candidates are cheapest to
state, and it trades a real structure for a readable one every time.
That is why the constraint lives here, downstream of the conjecturing,
rather than upstream in `/formalize`.
