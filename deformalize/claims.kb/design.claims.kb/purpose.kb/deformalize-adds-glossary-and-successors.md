...
# /deformalize Adds the Glossary and the Successor Theories

`/deformalize` takes `/formalize`'s very-formal output and adds two
...
(`../../../../formalize/claims.kb/design.claims.kb/setting.kb/plain-english-belongs-to-deformalize.md`)
